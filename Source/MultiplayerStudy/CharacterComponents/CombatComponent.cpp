...
void UCombatComponent::EquipWeapon(AWeapon* WeaponToEquip)
{
	...
	const USkeletalMeshSocket* HandSocket = Character->GetMesh()->GetSocketByName(FName("SOCKET_RightHand_AR"));
	if (HandSocket)
	{
...
void UCombatComponent::TraceUnderCrosshairs(FHitResult& TraceHitResult)
{
	...
	if (bScreenToWorld)
	{
		...
		{
			HUDPackage.CrosshairsColor = OnTargetCrosshairColor;
		}
		else
		{
			HUDPackage.CrosshairsColor = CrosshairColor;
		}
	}
}
